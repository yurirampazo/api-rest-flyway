...
public class PatientServiceImpl {
  ...
  private final ConsultZipCodeService consultZipCodeService;

  public PatientRegistrationDetailsDTO savePatient(PatientRegistrationDetailsDTO requestDto) {
    AddressDTO addressDTO = consultZipCodeService.validateAddressFromPatient(requestDto.getAddress());
    requestDto.setAddress(addressDTO);
    var patient = patientRepository.save(PatientMapper.toModel(requestDto));
